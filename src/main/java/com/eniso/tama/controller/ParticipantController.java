...
public class ParticipantController {
    ...
    public List<Participant> getParticipantPilier1() {
        ...
        List<Participant> participants = participantService.getParticipantPilier1();

        if (participants == null) {
            throw new RuntimeException("Theres no participant in pilier 1");
        }
    ...
    public List<Participant> getParticipantPilier2() {
        ...
        List<Participant> participants = participantService.getParticipantPilier2();

        if (participants == null) {
            throw new RuntimeException("Theres no participant in PILIER 2");
        }
